    ...
    <div className="flex items-center justify-center min-h-screen bg-white">
      <div className="bg-white p-6 rounded-lg max-w-8xl w-full">
        ...
        {!hasStarted && ( // Conditionally render the welcome message and slideshow if the user hasn't started
          <> <button
                onClick={() => setHasStarted(true)} // Set hasStarted back to false
                className="absolute top-14 left-14 bg-gray-200 text-black p-3 rounded-full hover:bg-gray-300 hover:text-gray-700 transition duration-300"
              >
        ...
        {hasStarted && (
          <div className="bg-white p-5 ml-5 mr-5 rounded-lg">
            ...
            <button
              onClick={() => setHasStarted(false)} // Set hasStarted back to false
              className="absolute top-14 left-14 bg-gray-200 text-black p-3 rounded-full hover:bg-gray-300 hover:text-gray-700 transition duration-300"
            >
              <FaArrowLeft size={24} />
            </button>
                ...
                {palette.length > 0 && palette.map((color, index) => (
                  <div key={index} className="relative flex flex-col items-center group">
                    ...
                    <div className="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <button
                        className="text-blue-300 hover:text-blue-700 flex items-center"
            ...
            <h2 className="text-2xl mt-12 text-center">My Palettes</h2>
